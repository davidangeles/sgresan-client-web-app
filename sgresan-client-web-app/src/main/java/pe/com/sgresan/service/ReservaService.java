...
public class ReservaService {
	...
	public void registrarReserva(Reserva objReserva) throws Exception {
		try {
			...
			List<String> listTipoHabitacion = new ArrayList<>();
			for (Habitacion objHabitacion : objReserva.getLstHabitacion()) {
				...
				listTipoHabitacion.add(objHabitacion.getTipoHabNombre());
			}
			...
			if(EstadoReservaTipo.PRE_RESERVA.getNombre().equals(objReserva.getEstado())){
				...
				objParams.put(CommonConstants.STR_KEY_MAP_ID, objReserva.getIdReserva().toUpperCase());
				objParams.put(CommonConstants.STR_KEY_MAP_CLIENTE,
						Utils.concatWithDelimiter(CommonConstants.STR_SPACE, objPersona.getNombres(), objPersona.getApellidoP(), objPersona.getApellidoM()).toUpperCase());
				objParams.put(CommonConstants.STR_KEY_MAP_HABITACION, 
						Utils.concatWithDelimiter(CommonConstants.STR_SEPARATOR + CommonConstants.STR_SPACE, listTipoHabitacion.toArray()).toUpperCase());
				...
				objParams.put(CommonConstants.STR_KEY_MAP_FECHAFIN, Utils.getString(objReserva.getFechaSalida()));
